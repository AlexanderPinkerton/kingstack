            ...
            <NeonCard className="p-8">
              <div className="mb-8">
                <h1 className="text-4xl font-extrabold mb-4">
                  <GradientText>Theme Builder</GradientText>
                </h1>
                <p className="text-lg text-slate-300">
                  Choose from preset themes or customize every color variable to
                  create your perfect theme. Export your theme as CSS or JSON.
                </p>
              </div>
