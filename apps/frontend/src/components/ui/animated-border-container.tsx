...
export function AnimatedBorderContainer({ className = "", children }: { className?: string; children: React.ReactNode }) {
  return (
    <div className={`relative ${className}`}>
      ...
      <div className="absolute -inset-1 rounded-3xl bg-gradient-to-r from-[var(--gradient-from)] via-[var(--gradient-to)] to-[var(--gradient-from)] opacity-60 blur-xl animate-pulse z-0" />
