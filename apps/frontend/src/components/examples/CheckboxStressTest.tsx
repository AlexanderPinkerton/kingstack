    ...
    <div className="max-w-7xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-300 text-lg max-w-3xl mx-auto leading-relaxed mb-6">
          Hybrid streaming + virtualization system handling 5,000 checkboxes
          with real-time updates. Only visible checkboxes are rendered in the
          DOM for optimal performance.
        </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="p-4 bg-slate-700/30 rounded-lg border border-slate-600">
          ...
          <div className="text-slate-400 text-sm">
            {currentLayout.itemsPerRow} ×{" "}
            {Math.ceil(5000 / currentLayout.itemsPerRow)} grid
          </div>
        </div>
      </div>
      ...
      <div className="bg-slate-800/50 backdrop-blur-sm rounded-2xl border border-slate-600 shadow-2xl p-6">
        ...
        <p className="text-slate-400 mb-6">
          Scroll to explore all 5,000 checkboxes in a{" "}
          {currentLayout.itemsPerRow}×
          {Math.ceil(5000 / currentLayout.itemsPerRow)} grid. Only visible
          checkboxes are rendered for optimal performance. Changes sync in
      ...
      <div className="mt-8 p-6 bg-gradient-to-r from-slate-700/30 to-slate-800/30 rounded-xl border border-slate-600">
        <div className="text-center">
          ...
          <p className="text-slate-300 mb-4">
            This stress test demonstrates a hybrid approach combining streaming
            data loading, virtual scrolling, and smart caching to handle large
