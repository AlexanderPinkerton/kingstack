    ...
    <div className="p-8 bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm rounded-2xl border border-slate-600 shadow-2xl">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="flex items-center space-x-3 p-4 bg-slate-700/30 rounded-lg border border-slate-600">
          ...
          <div>
            ...
            <div className="text-slate-400 text-sm">UI responds immediately</div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3 p-4 bg-slate-700/30 rounded-lg border border-slate-600">
          ...
          <div>
            ...
            <div className="text-slate-400 text-sm">Failed operations revert</div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-3 p-4 bg-slate-700/30 rounded-lg border border-slate-600">
          ...
          <div>
            ...
            <div className="text-slate-400 text-sm">Real-time collaboration</div>
          </div>
        </div>
      </div>
      ...
      <div className="mb-6">
        ...
        <p className="text-slate-400 mb-4">
          Click any checkbox below to see optimistic updates in action. 
          Open this page in multiple tabs to experience real-time synchronization.
        </p>
      ...
      <div className="mt-8 p-6 bg-gradient-to-r from-slate-700/30 to-slate-800/30 rounded-xl border border-slate-600">
        <div className="text-center">
          ...
          <p className="text-slate-300 mb-4">
            This demo showcases our optimistic store pattern with real-time synchronization. 
            Perfect for collaborative apps, real-time dashboards, and interactive experiences.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center space-y-2 sm:space-y-0 sm:space-x-4">
            <div className="flex items-center space-x-2 text-sm text-slate-400">
              <div className="w-2 h-2 bg-emerald-400 rounded-full animate-pulse" />
              <span>Socket: {rootStore.socket?.connected ? 'Connected' : 'Disconnected'}</span>
            </div>
