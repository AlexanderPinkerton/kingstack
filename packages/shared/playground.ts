    ...
    posts: [
      {
        ...
        content:
          "This is a demo post showing how KingStack works in playground mode. No database required!",
        created_at: new Date().toISOString(),
        updated_at: new Date().toISOString(),
        user_id: "playground-user",
        published: true,
      },
      {
        ...
        content:
          "All the ShadCN components are available for testing and development.",
